var TemporalFilter = (function() {
  ...
  function filter_mail() {
    ...
    if (this.trash) {
      ...
      let messages_processed = TemporalFilter.mail_fetcher.applyToQueryMessages(trash_query, message => message.trash());
    ...
    if (this.archive) {
      ...
      let messages_processed = TemporalFilter.mail_fetcher.applyToQueryMessages(archive_query, message => message.archive());
    ...
    if (this.read) {
      ...
      let messages_processed = TemporalFilter.mail_fetcher.applyToQueryMessages(read_query, message => message.markRead());
